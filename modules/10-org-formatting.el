...
(with-eval-after-load 'org
  (define-key org-mode-map (kbd "C-c C-x C-b") 'my/org-toggle-bold)
  (define-key org-mode-map (kbd "C-c C-x C-i") 'my/org-toggle-italic)
  (define-key org-mode-map (kbd "C-c C-x C-s") 'my/org-toggle-strikethrough)
  (define-key org-mode-map (kbd "C-c C-x C-u") 'my/org-toggle-uppercase))
