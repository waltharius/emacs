...
(custom-set-faces
 ...
 '(org-block ((t (:inherit fixed-pitch :background "#fef8e0" :extend t))))
 ...
 '(org-code ((t (:inherit fixed-pitch :foreground "dark green" :weight normal))))
 ...
 '(org-link ((t (:inherit fixed-pitch :height 1.0 :foreground "#555555" :underline nil :weight normal))))
 '(org-meta-line ((t (:inherit fixed-pitch))))
 '(org-property-value ((t (:inherit modus-themes-fixed-pitch :foreground "dark violet"))))
 '(org-quote ((t (:inherit variable-pitch :background "#f9f9f9" :foreground "#555555" :slant italic :height 1.1))))
 ...
 '(org-verbatim ((t (:inherit fixed-pitch :weight normal)))))
